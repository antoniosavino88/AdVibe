<x-layout>
    ...
    <div class="bg-page-form min-vh-100">
        <div class="container">
            ...
            <div class="row height-custom justify-content-evenly py-5">
                {{-- COLONNA IMMAGINI --}}
                <div class="col-12 col-lg-5 py-0 py-md-5 order-2 order-lg-1">
                ...
                {{-- COLONNA TESTI --}}
                <div class="col-12 col-lg-5 my-5 py-0 py-md-5 text-start order-1 order-lg-2 colonna-testi">
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <h1 class="text-title text-title-show text-color-5"> {{ $ad->title }}</h1>
                            <div class="justify-content-between position-relative row">
                                <h2 class="text-title col-10">€ {{ $ad->price }}</h2>
                                <div class="col-2">
