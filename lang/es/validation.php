...
return [
    ...
    */
    ...
    'max' => [
        ...
        'file' => 'El archivo no puede pasar mas de :max kilobytes.',
    ...
    */
    ...
    'attributes' => ['title'=>'título','description'=>'descripción', 'price'=>'precio', 'category_id'=>'categoría', 'name'=>'Nombre de usuario', 'email'=>'Correo electrónico', 'password'=>'Contraseña'],
];
